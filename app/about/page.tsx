            ...
            {features.map((item, i) => (
              ...
              >
                <IconRenderer
                  ...
                  color={item.color}
                />
                <h4 className="font-bold text-lg md:text-xl text-white mb-2 mt-4">
                  {item.title}
                </h4>
            ...
            {technologies.map((tech, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    width: responsiveOrbit * 2,
                    height: responsiveOrbit * 2,
                  }}
                >
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2 mt-4">
                        {step.deliverables.map((d, i) => (
                          <span
                            key={i}
                            className="text-[9px] font-mono bg-white/5 px-2 py-1 rounded-full text-white/30"
                          >
                            {d}
                          </span>
                        ))}
        ...
        >
          ...
          <div className="text-center relative z-10">
            ...
            <p className="text-white/40 text-lg mb-10 max-w-2xl mx-auto">
              Let&apos;s build something extraordinary together. Join the ranks
