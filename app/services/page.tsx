            ...
            {services.map((service, i) => (
              ...
              >
                ...
                <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                  <div>
                    <span className="text-[9px] font-mono uppercase tracking-widest text-white/20 block mb-1">
                      Tech Stack
                    </span>
                    <span
