...
const PremiumSpinner: React.FC<PremiumSpinnerProps> = ({
  loadingTexts = ["Loading", "Fetching Data", "Processing", "Almost Ready"], // ✅ ডিফল্ট ভ্যালু
  ...
  useEffect(() => {
    ...
    const textInterval = setInterval(() => {
      if (textIndex < (loadingTexts?.length || 0)) {
        setLoadingText(loadingTexts?.[textIndex] || "Loading");
        textIndex++;
      }
    }, 800);
