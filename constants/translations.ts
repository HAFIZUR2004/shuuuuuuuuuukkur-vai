...
export const translations = {
  EN: {
    ...
    careersPage: {
      ...
      heroTitle: "JOIN THE DIGITAL",
      heroTitleGradient: "PROTOCOL",
      heroDesc:
      ...
      heroBtnPrimary: "Explore Open Roles",
      heroBtnSecondary: "Our Philosophy",
      scrollText: "Scroll",

      manifestoZone: "Zone: Manifesto",
      manifestoTitle: "PRECISION OVER",
      manifestoTitleGradient: "CONVENIENCE.",
      manifestoDesc:
      ...
      manifestoItem1Title: "Async Native",
      manifestoItem1Desc: "Designed for deep work. No useless stand-ups.",
      manifestoItem2Title: "Tech Sovereign",
      manifestoItem2Desc: "We own the stack. No technical debt compromises.",

      vacanciesLabel: "Operational Series",
      vacanciesTitle: "AVAILABLE",
      vacanciesTitleGradient: "VACANCIES",
      engineering: "Engineering",
      design: "Design",
      roles: "Roles",
      addNew: "+ Add New Vacancy",
    ...
    applyPage: {
      ...
      experience1_3: "1-3 Years",
      experience3_5: "3-5 Years",
      experience5_8: "5-8 Years",
      experience8plus: "8+ Years",
      requiredField: "Required field",
      fileSizeError: "File size cannot exceed 5MB",
      fileUploaded: "uploaded",
      vacancyNotFound: "Vacancy Not Found",
      backToCareersBtn: "Back to Careers",
      loading: "Loading...",
      successMessage:
        "✅ Your application has been submitted successfully! We will contact you soon.",
      errorMessage: "Failed to submit application. Please try again.",
      validationNameEmail: "Please provide your name and email",
      validationResume: "Please upload your resume",
      acceptFormats: "PDF, DOC, DOCX (Max 5MB)",
      tellAboutYourself:
        "Tell us about your experience, skills, and why you're the right fit for this position...",
      placeholderName: "John Doe",
      placeholderEmail: "john@example.com",
      placeholderPhone: "+880 1234 567890",
  ...
  BN: {
    ...
    //careersPage
    careersPage: {
      heroBadge: "আমরা নিয়োগ দিচ্ছি",
      heroTitle: "ডিজিটালে যোগ দিন",
      heroTitleGradient: "প্রটোকল",
      heroDesc:
        "একটি ডেটা-চালিত ভবিষ্যতের জন্য উচ্চ-ক্ষমতাসম্পন্ন ডিজিটাল ইকোসিস্টেম স্থাপত্যবিদ। জটিল প্রক্রিয়াগুলোকে মার্জিত স্বয়ংক্রিয় সমাধানে রূপান্তর করতে এআই ব্যবহার করুন।",
      heroBtnPrimary: "খোলা পদ দেখুন",
      heroBtnSecondary: "আমাদের দর্শন",
      scrollText: "স্ক্রল",

      manifestoZone: "জোন: ম্যানিফেস্টো",
      manifestoTitle: "নির্ভুলতা",
      manifestoTitleGradient: "সুবিধার উপর।",
      manifestoDesc:
        "আমরা শুধু সফটওয়্যার তৈরি করি না। আমরা ডিজিটাল পরিবেশ গঠন করি যেখানে ডেটা আর্কিটেকচারাল এলিগ্যান্সের সাথে প্রবাহিত হয়। আমাদের সংস্কৃতি গভীর ফোকাস, আমূল স্বায়ত্তশাসন এবং প্রকৌশল প্রতিপত্তির নিরলস সাধনায় নিহিত।",
      manifestoItem1Title: "অ্যাসিনক নেটিভ",
      manifestoItem1Desc: "গভীর কাজের জন্য ডিজাইন করা। অযথা স্ট্যান্ড-আপ নেই।",
      manifestoItem2Title: "টেক সার্বভৌম",
      manifestoItem2Desc:
        "আমরা স্ট্যাকের মালিক। কোনো টেকনিক্যাল ডেট কম্প্রোমাইস নেই।",

      vacanciesLabel: "অপারেশনাল সিরিজ",
      vacanciesTitle: "উপলব্ধ",
      vacanciesTitleGradient: "পদসমূহ",
      engineering: "ইঞ্জিনিয়ারিং",
      design: "ডিজাইন",
      roles: "পদ",
      addNew: "+ নতুন পদ যোগ করুন",
      loading: "পদ লোড হচ্ছে...",
      edit: "সম্পাদনা",
      delete: "মুছুন",
      applyNow: "এখনই আবেদন করুন →",
      submitPitch: "পিচ জমা দিন →",
      salary: "বেতন",

      editVacancy: "পদ সম্পাদনা",
      createVacancy: "নতুন পদ তৈরি",
      title: "শিরোনাম",
      description: "বিবরণ",
      tags: "ট্যাগ (কমা দিয়ে আলাদা করুন)",
      techStack: "টেক স্ট্যাক (কমা দিয়ে আলাদা করুন)",
      salaryRange: "বেতন পরিসীমা",
      department: "বিভাগ",
      color: "রং",
      featured: "বৈশিষ্ট্যযুক্ত পদ",
      cancel: "বাতিল",
      update: "আপডেট",
      create: "তৈরি করুন",

      whyBuildLabel: "প্রটোকল · পুরস্কার",
      whyBuildTitle: "কেন আমাদের সাথে",
      whyBuildTitleGradient: "নির্মাণ করবেন",
      whyBuildDesc:
        "এমন একটি সম্মিলনে যোগ দিন যা আপনার অবদানের মতো আপনার বৃদ্ধিকেও মূল্য দেয়",
      perk1Title: "ইকুইটি ও মালিকানা",
      perk1Desc:
        "উদার স্টক অপশন। আপনি একজন কর্মচারী নন; আপনি ইকোসিস্টেমের বৃদ্ধিতে একজন প্রাথমিক স্টেকহোল্ডার।",
      perk2Title: "রিমোট স্বায়ত্তশাসিত",
      perk2Desc:
        "বিশ্বের যেকোনো নোড থেকে কাজ করুন। আমরা ঘড়ির সময় নয়, আউটপুটের গুণমানের উপর ফোকাস করি।",
      perk3Title: "স্বাস্থ্য প্রটোকল",
      perk3Desc:
        "প্রিমিয়াম গ্লোবাল হেলথ কভারেজ এবং প্রতি বছর বাধ্যতামূলক ৪-সপ্তাহের 'ডিপ সাবাথ' ছুটি।",
      perk4Title: "লার্নিং বাজেট",
      perk4Desc:
        "কনফারেন্স, কোর্স এবং অত্যাধুনিক সার্টিফিকেশনের জন্য বার্ষিক $৫,০০০ বাজেট।",
      retentionRate: "ধারণ হার",
      globalTeam: "গ্লোবাল টিম",
      glassdoorRating: "গ্লাসডোর রেটিং",

      ctaTitle: "শুরু করতে প্রস্তুত",
      ctaTitleGradient: "অনুক্রম?",
      ctaDesc:
        "একটি দলে যোগ দিন যা কর্পোরেট ঐতিহ্যের চেয়ে প্রযুক্তিগত দক্ষতাকে মূল্য দেয়। আপনার সেরা কাজ এখানে শুরু হয়।",
      ctaBtn: "আবেদন শুরু করুন",
    },
    //applyPage
    applyPage: {
      backToCareers: "← ক্যারিয়ারে ফিরে যান",
      applyFor: "জন্য আবেদন করুন",
      ...
      profileLinks: "প্রোফাইল লিংক",
      portfolio: "পোর্টফোলিও/ওয়েবসাইট",
      linkedin: "লিংকডইন",
      github: "গিটহাব",
      documents: "ডকুমেন্টস",
      resume: "রিজিউম/সিভি",
      ...
      selectExperience: "সিলেক্ট করুন",
      experience0_1: "০-১ বছর",
      experience1_3: "১-৩ বছর",
      experience3_5: "৩-৫ বছর",
      experience5_8: "৫-৮ বছর",
      experience8plus: "৮+ বছর",
      requiredField: "আবশ্যক ফিল্ড",
      fileSizeError: "ফাইলের সাইজ ৫এমবির বেশি হতে পারবে না",
      fileUploaded: "আপলোড হয়েছে",
      vacancyNotFound: "পদ খুঁজে পাওয়া যায়নি",
      backToCareersBtn: "ক্যারিয়ারে ফিরে যান",
      loading: "লোড হচ্ছে...",
      successMessage:
        "✅ আপনার আবেদন সফলভাবে জমা হয়েছে! আমরা শীঘ্রই যোগাযোগ করব।",
      errorMessage: "আবেদন জমা দিতে ব্যর্থ হয়েছে। দয়া করে আবার চেষ্টা করুন।",
      validationNameEmail: "অনুগ্রহ করে আপনার নাম এবং ইমেইল প্রদান করুন",
      validationResume: "অনুগ্রহ করে আপনার রিজিউম আপলোড করুন",
      acceptFormats: "PDF, DOC, DOCX (সর্বোচ্চ ৫এমবি)",
      tellAboutYourself:
